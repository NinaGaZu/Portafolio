...
const Contacto = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceID = 'service_x6sfl5r';
    const templateID = 'template_96qjnbd';
    const userID = 'kXsWUHj4VrkPXTa_h'; // Public Key
  ...
  return (
    ...
    <section id="contacto" className="bg-indigo-600 py-16 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="px-6 py-3 bg-white text-indigo-600 rounded-lg font-semibold hover:bg-opacity-90 transition-colors duration-300"
            >
              Enviar mensaje
            </button>
          </div>
        ...
        <div className="mt-12">
          <h3 className="text-white text-xl mb-4">También puedes encontrarme en:</h3>
